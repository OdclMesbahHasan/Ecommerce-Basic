...
public class AdminController {
    ...
    public String verifyCredentials(@ModelAttribute("admin") Admin admin, org.springframework.ui.Model model) {
    ...
    public String adminHomePage(org.springframework.ui.Model model) {
